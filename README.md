...
本项目部署在腾讯云，已经做到push源码后全自动编译并将数据更新到线上网站中。
...
如果你按照上述规范整理好文件后，在项目的`python`文件夹下，有一个`voicesListGenerator.py`脚本，用于**根据文件路径名**自动生成配置文件。
